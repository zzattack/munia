...
void Configurator_SetReport(void* itf, USBD_HID_ReportType type, uint8_t* data, uint16_t length);
void Configurator_GetReport(void* itf, USBD_HID_ReportType type, uint8_t reportId);
