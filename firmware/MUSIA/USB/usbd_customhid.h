...
EXTERNC uint8_t USBD_HID_PS2_SendReport(USBD_HandleTypeDef *pdev, uint8_t *report, uint16_t len);
EXTERNC uint8_t  USBD_HID_PS2_RegisterInterface(USBD_HandleTypeDef   *pdev, USBD_CUSTOM_HID_ItfTypeDef *fops);

EXTERNC uint8_t USBD_HID_CFG_SendReport(USBD_HandleTypeDef *pdev, uint8_t *report, uint16_t len);
EXTERNC uint8_t  USBD_HID_CFG_RegisterInterface(USBD_HandleTypeDef   *pdev, USBD_CUSTOM_HID_ItfTypeDef *fops);
